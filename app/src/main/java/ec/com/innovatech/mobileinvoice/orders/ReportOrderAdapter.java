...
public class ReportOrderAdapter extends PrintDocumentAdapter {
    ...
    public ReportOrderAdapter(Context context, List<DetailOrder> detailOrders){
    ...
    private void drawPage(PdfDocument.Page page) {
        ...
        canvas.drawText("Reporte de pedidos", leftMargin, titleBaseLine, paint);
        ...
        if(!CollectionUtils.isEmpty(detailOrders)) {
            for (DetailOrder det : detailOrders) {
                titleBaseLine = titleBaseLine + 25;
